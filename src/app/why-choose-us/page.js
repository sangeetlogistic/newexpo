...
export const metadata = buildMetadata({
  title:
    "Why Choose Us | Reliable Agricultural Exporter India | Verified Export House",
  description:
    "Choose Maheshwari Global Exports for process-driven sourcing, verified supplier network, shipment consistency, and transparent long-term trade relationships. Trusted by global buyers.",
  keywords: [
    "reliable agricultural exporter india",
    "trusted export house india",
    "why choose indian exporter",
    "verified agro exporter",
    "consistent export quality india",
    "b2b agricultural supplier india",
    "structured export house gujarat",
  ],
  path: "/why-choose-us",
});
...
const comparisonRows = [
  ...
  [
    "Sample-to-Shipment Match",
    "✅ Non-negotiable standard",
    "⚠️ Not systematically tracked",
  ],
  ...
  return (
    <>
      ...
      >
        ...
        >
          <AnimatedSection>
            ...
            >
              Process-driven. Quality-verified. Reliability-first — structure
      ...
      <section
        ...
        style={{ padding: "100px 2rem", background: "#f4f5f7" }}
      >
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <AnimatedSection>
            <div style={{ textAlign: "center", marginBottom: "64px" }}>
              ...
              >
                Six pillars that define how we operate — no exceptions.
              </p>
            </div>
          </AnimatedSection>
            ...
            >
              ...
              >
                ...
                >
                  {[
                    "Parameter",
                    "Maheshwari Global Exports",
                    "Typical Broker / Exporter",
                  ].map((h, i) => (
                    <div
                      key={h}
                      style={{
      ...
      >
        <div
          style={{
            ...
            height: "300px",
            background:
              "radial-gradient(circle, rgba(0,115,230,0.15) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
