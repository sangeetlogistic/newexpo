...
export const metadata = {
  metadataBase: new URL('https://www.maheshwariglobalexports.com'),
  title: {
    default: 'Maheshwari Global Exports | Agricultural Exporter from India | Rice & Spice Export Company',
