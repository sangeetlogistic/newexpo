...
export const metadata = buildMetadata({
  ...
  keywords: [
    "agricultural exporter from india",
    "rice exporter india",
    "spice exporter india",
    "merchant exporter india",
    "gujarat export company",
    "b2b agricultural exporter",
    "reliable rice exporter from india",
...
const products = [
  {
    ...
    img: imgRice,
    imgAlt:
      "Premium long-grain basmati rice grains in a wooden bowl for export",
    path: "/products",
  },
  {
    name: "Indian Spices",
    ...
    img: imgSpices,
    imgAlt:
      "Colorful Indian spices — red chili, turmeric, coriander, star anise for export",
    path: "/products",
  },
  {
    name: "Pulses & Lentils",
...
const whyUs = [
  {
    ...
    desc: "Every supplier evaluated for quality, compliance, and delivery reliability.",
  },
  {
    icon: "📦",
    title: "Sample = Shipment",
    desc: "Approved sample matches every delivered shipment. No exceptions.",
  },
  {
    icon: "📋",
    title: "Full Documentation",
    desc: "Phytosanitary, FSSAI, export docs — complete compliance for every destination.",
  },
  {
    icon: "🌍",
    title: "Global Reach",
    desc: "Serving GCC, Middle East, Africa, and Southeast Asia with structured exports.",
  },
  {
    icon: "⚡",
    title: "Fast Turnaround",
    desc: "Streamlined sourcing and logistics for responsive, on-time delivery.",
  },
  {
    icon: "🤝",
    title: "Long-term Partnerships",
    desc: "Built on trust, transparency and a disciplined trade execution model.",
  },
];
  ...
  return (
    <>
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(105deg, rgba(5,5,5,0.92) 0%, rgba(5,5,5,0.80) 40%, rgba(5,5,5,0.45) 70%, rgba(5,5,5,0.2) 100%)",
          }}
        />
        {/* Blue glow top-right */}
        <div
          style={{
            ...
            height: "500px",
            background:
              "radial-gradient(circle, rgba(0,115,230,0.18) 0%, transparent 65%)",
            pointerEvents: "none",
          }}
        />
            ...
            <div>
              <AnimatedSection>
                ...
                >
                  ...
                  >
                    Gujarat-Based Merchant Export House · New Generation Export
                    House
                  </span>
                </div>
              </AnimatedSection>
              ...
              <AnimatedSection delay={80}>
                ...
                <h1
                  style={{
                    ...
                    fontFamily: "Poppins, sans-serif",
                    margin: "0 0 6px",
                    background: "linear-gradient(90deg, #3395f0, #0073e6)",
              ...
              <AnimatedSection delay={160}>
                ...
                >
                  Premium Indian agricultural exports — rice, spices, pulses,
                  and fresh produce — with structured global delivery to GCC,
                    ...
                    >
                      <span
                        style={{
                          ...
                          border: "1px solid rgba(51,149,240,0.5)",
                          borderRadius: "50%",
                          display: "flex",
                          alignItems: "center",
              ...
              >
                {stats.map((s, i) => (
                  <div
                    ...
                    style={{
                      ...
                      padding: "24px 16px",
                      textAlign: "center",
                      borderTop: `2px solid ${i % 2 === 0 ? "rgba(0,115,230,0.6)" : "rgba(51,149,240,0.35)"}`,
                    }}
                  >
                    <div
                      style={{
                ...
                <div
                  style={{
                    ...
                    borderRadius: "10px",
                    padding: "18px 20px",
                    borderTop: "2px solid rgba(0,115,230,0.4)",
                  }}
                >
                  <div
                    style={{
                  ...
                  >
                    {["GCC", "Middle East", "Africa", "SE Asia", "Europe"].map(
                      (m) => (
                        <span
                          key={m}
                          style={{
                            background: "rgba(0,115,230,0.18)",
                            border: "1px solid rgba(51,149,240,0.35)",
                            color: "#66b2f5",
                            fontSize: "11px",
                            fontWeight: 600,
                            padding: "4px 10px",
      ...
      <div
        style={{
          background:
            "linear-gradient(90deg, #0052b3, #0073e6, #3395f0, #0073e6, #0052b3)",
          padding: "11px 2rem",
        }}
      >
        <div
        ...
        >
          {[
            "Rice · Spices · Pulses · Fresh Produce",
            "Gujarat, India → 20+ Global Markets",
            "APEDA Registered · FSSAI Certified",
          ].map((t) => (
            <span
              key={t}
              style={{
      ...
      <section style={{ padding: "96px 2rem", background: "#ffffff" }}>
        ...
        >
          <AnimatedSection>
            ...
            >
              In international sourcing, inconsistency is the biggest risk.
              Approved samples often fail to match final shipments.
            </p>
            <p
              style={{
                color: "#5a6272",
            ...
            >
              Maheshwari Global Exports was built to eliminate that gap —
              through disciplined{" "}
              <strong style={{ color: "#0a0a0a" }}>
                supplier verification
              </strong>
              , structured pre-shipment checks, and execution-focused logistics.
            </p>
            <div
              style={{
                background: "#eff6ff",
            ...
            >
              ...
              >
                We do not trade opportunistically.
              </p>
              <p
                style={{
                  color: "#0062cc",
              ...
              >
                We build repeatable supply systems.
              </p>
            </div>
            <Link
              href="/about"
          ...
          <AnimatedSection delay={150}>
            <div style={{ position: "relative" }}>
              ...
              >
                <Image
                  src={imgGlobalTrade}
                  alt="Export operations and logistics in Rajkot Gujarat India"
                  fill
                ...
                >
                  ...
                  >
                    Rajkot, Gujarat — India&apos;s Export Belt
                  </div>
                </div>
              </div>
              {/* Floating badge */}
              <div
                style={{
                  ...
                  padding: "18px 22px",
                  borderRadius: "10px",
                  boxShadow: "0 8px 28px rgba(0,115,230,0.45)",
                  textAlign: "center",
                }}
              >
                <div
        ...
        <div style={{ maxWidth: "1280px", margin: "0 auto" }}>
          <AnimatedSection>
            <div style={{ textAlign: "center", marginBottom: "56px" }}>
              ...
              >
                Every decision we make is built around one goal — consistency
                you can rely on.
              </p>
            </div>
          </AnimatedSection>
      ...
      <section style={{ padding: "88px 2rem", background: "#f4f5f7" }}>
        ...
        >
          <AnimatedSection>
            ...
            >
              From Gujarat&apos;s farms to dinner tables across four continents
              — structured, reliable, and fully documented.
            </p>
            <div
              style={{
                display: "grid",
              ...
              {markets.map((m) => (
                ...
                >
                  ...
                  <div style={{ minWidth: 0 }}>
                    ...
                    >
                      {m.countries.map((country) => country.name).join(" · ")}
                    </div>
                  </div>
                </div>
              ))}
      ...
      >
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "linear-gradient(135deg,rgba(0,82,179,0.6) 0%,rgba(5,5,5,0.85) 60%)",
          }}
        />
        <div
          style={{
          ...
          <AnimatedSection>
            <div
              style={{
                ...
                height: "3px",
                background:
                  "linear-gradient(90deg,#3395f0,rgba(255,255,255,0.4))",
                borderRadius: "2px",
                marginBottom: "18px",
              }}
            />
            ...
            >
              Connect with Gujarat&apos;s reliable merchant export house for
              structured, quality-verified sourcing.
            </p>
          </AnimatedSection>
          <AnimatedSection delay={150}>
            <div
